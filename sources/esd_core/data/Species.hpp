...
constexpr Specie human = [](Specie s) {
...
constexpr Specie eridani_empire = [](Specie s) {
...
constexpr Specie hydran_progress = human;

constexpr Specie planta = [](Specie s) {
...
constexpr Specie decendants_of_draco = [](Specie s) {
  s.default_Tiles[s.default_Tiles_count++] = nano_fusion_drive;
  return s; }(human);

constexpr Specie mechanema = [](Specie s) {
  s.default_Tiles[s.default_Tiles_count++] = grid_positron_computer;
  return s; }(human);

constexpr Specie orion_hegemony = [](Specie s) {
  s.interceptor_energy = blueprint_energy_1;
...
constexpr Specie terran_directorate = human;
constexpr Specie terran_federation = human;
constexpr Specie terran_union = human;
constexpr Specie terran_republic = human;
constexpr Specie terran_conglomerate = human;
constexpr Specie terran_alliance = human;
